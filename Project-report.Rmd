...
* Transitivity: Raportul dintre numarul de triunghiuri inchise (trei noduri interconectate fiecare cu fiecare) si numarul de triunghiuri deschise si inchise (subgraf conex format din trei noduri)
```{r}
## "Five-Number Summary"
...
# Capitolul 4: Bazele plotarii retelelor si ale layout-ului
## Circle
```{r}
...
# Capitolul 5: Design eficient al graficelor retelelor
```{r}
library(network)
...
# Capitolul 6: Grafice avansate pentru retele
## Tkplot
```{r}
...
Cu exceptia acestora, exista si alte masuri ale centralitati, insa rezultatele multora dintre acestea sunt corelate cu cele ale metodele prezentate anterior. Acest fapt este evidentiat si in calculele prezentate anterior si poate fi explicat prin faptul ca aceste masuratori, pornesc de la aceste metode de baza si aduc imbunatatiri.
```{r}
...
Similar cu nodurile critice, se poate defini si notiunea de muchie critica. Aceasta reprezinta o legatura care daca este eliminata, va strica conectivitatea retelei. Codul urmator ilustreaza cum pot fi determinate aceste muchii critice in reteaua prezentata.
```{r}
